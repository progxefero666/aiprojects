...
export const getDefaultValueType = (type: string): string => {
    let baseType: string = DataConstants.BASETYPE_STRING;
    switch (type) {
        case HtmlCompTypes.INPUT_NUMBER:
        case HtmlCompTypes.INPUT_RANGE:
            baseType = DataConstants.BASETYPE_NUMBER;
            break;
        case HtmlCompTypes.INPUT_CHECK:
            baseType = DataConstants.BASETYPE_BOOLEAN;
            break;
        case HtmlCompTypes.FILE:
            baseType = DataConstants.UNDEFINED;
            break;
        case HtmlCompTypes.INPUT_DATE:
            baseType = DataConstants.BASETYPE_DATETIME;
            break;
        case HtmlCompTypes.INPUT_TIME:
            baseType = DataConstants.BASETYPE_TIME;
            break;
    }
    return baseType;
}
